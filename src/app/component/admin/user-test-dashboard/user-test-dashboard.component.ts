...
@Component({
  ...
  styleUrls: ['./user-test-dashboard.component.scss']
})
export class UserTestDashboardComponent implements OnInit {
  ...
  notificationVisibilityWhenDelete = 'none';
  notificationVisibilityWhenDelete1 = 'none';
  ...
  clickVaoThi(id: number) {
    this.idExam = id;
    this.notificationVisibilityWhenDelete = 'block';
  }
  // Click vào thi
  clickVaoThiP(id) {
    this.idExam = id;
    this.notificationVisibilityWhenDelete1 = 'block';
  }
  ...
  oncg1(event: boolean) {
    if (event) {
      ...
      this.notificationVisibilityWhenDelete1 = 'none';
    }
  }
